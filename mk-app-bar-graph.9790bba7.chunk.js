...
var _config = __webpack_require__(570);
...
var action = function action(option) {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return _this.webapi.bargraph.query();
    ...
    this.getOption = function () {
        ...
        var data = _this.metaAction.gf('data').toJS();
...
var _data = __webpack_require__(591);
...
var reducer = function reducer(option) {
    ...
    this.load = function (state, response) {
        state = _this.metaReducer.sf(state, 'data.xAxisData', (0, _immutable.fromJS)(response.xAxisData));
        state = _this.metaReducer.sf(state, 'data.seriesData', (0, _immutable.fromJS)(response.seriesData));
        return state;
    };
...
//# sourceMappingURL=mk-app-bar-graph.9790bba7.chunk.js.map